...
/*
  ...
  1. TAB 1: "My Account Submissions" (Logged-In Users):
     - Displays list of problems submitted via citizen account with visual StatusTimeline.
  ...
  2. TAB 2: "🛡️ Track Anonymous Problem via Secret Key":
     ...
     - Displays complete StatusTimeline, assigned university proposal, prototype demo, and a button to submit "Ground-Truth Verification & Rating".
*/
